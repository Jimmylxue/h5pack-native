  ...
  const a = new (class {
    ...
    callNative(e, t, r) {
      return new Promise((a, s) => {
        ...
        this.callbacks.set(i, {resolve: a, reject: s, timeoutId: c});
        const o = {
          type: 'bridge_call',
          callId: i,
          module: e,
  ...
  a.registerModule('camera', new r(a)),
    ...
    a.registerModule(
      ...
      new (class extends t {
        ...
        async exit(e = {}) {
          try {
            return await this.call('exit', e);
          } catch (e) {
            return this.handleError(e, 'Failed to exit');
          }
        }
        async relaunch(e = {}) {
          try {
            return await this.call('relaunch', e);
          } catch (e) {
            return this.handleError(e, 'Failed to relaunch');
          }
        }
        async refresh(e = {}) {
          try {
            return await this.call('refresh', e);
          } catch (e) {
            return this.handleError(e, 'Failed to refresh');
          }
        }
      })(a),
    ),
